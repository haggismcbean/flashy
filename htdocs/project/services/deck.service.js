...
.factory('deckService', [ function(){
    ...
    deckService.getAllDecks = function(){
        return decks;
    };

    deckService.addDeck = function(deck){
        decks = decks.push(deck);
        return decks;
    };

    deckService.getDeck = function(id){
        return decks.find(function(deck, key, number) {
            return deck.id === Number(id);
        });
    };
